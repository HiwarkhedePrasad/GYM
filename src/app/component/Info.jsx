...
export default function HomeHeroInfo() {
  ...
  return (
    <section className="relative bg-white">
      {/* Mobile: no overlap, Desktop: overlap with negative margin */}
      <div className="container mx-auto relative top-0 md:-top-[50px] md:left-0 lg:-left-[12%] bg-black text-white p-6 sm:p-10 md:p-16 shadow-xl w-full md:w-4/5">
        <motion.div
          ref={ref}
        ...
        >
          {/* Contact Info Block */}
          <motion.div variants={itemVariants} className="flex items-start gap-4 sm:gap-6">
            <svg
            ...
            <div className="flex flex-col min-w-0">
              <div className="text-base sm:text-lg font-bold uppercase tracking-widest text-white mb-3 sm:mb-4">
                Contact
              </div>
              <a
                href="mailto:phiwarkhede05@gmail.com"
                className="text-sm sm:text-lg font-medium text-white hover:text-gray-300 transition-colors duration-200 mb-2 break-all"
              >
          ...
          <motion.div variants={itemVariants} className="flex items-start gap-4 sm:gap-6">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-4 mb-2">
                <span className="text-sm sm:text-base text-gray-400">Mon - Sat (Morning)</span>
                <span className="text-base sm:text-lg text-white font-semibold">5:30AM - 10:00AM</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-4 mb-2">
                <span className="text-sm sm:text-base text-gray-400">Mon - Sat (Evening)</span>
                <span className="text-base sm:text-lg text-white font-semibold">4:30PM - 10:00PM</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="flex items-start gap-4 sm:gap-6">
            <svg
              ...
              viewBox="0 0 384 512"
              fill="currentColor"
              className="h-8 w-8 sm:h-10 sm:w-10 flex-shrink-0 text-white"
            ...
            <div className="flex flex-col min-w-0">
              ...
              <div className="text-sm sm:text-lg font-medium text-gray-400 leading-relaxed">
